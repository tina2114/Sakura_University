...
#ifndef CLION_STL_STL_ALGOBASE_H
#define CLION_STL_STL_ALGOBASE_H
...
#include <cstring>
#pragma once
#ifndef ZHZ_STL_STL_ALGOBASE_H
#define ZHS_STL_STL_ALGOBASE_H
...
struct __copy_backward_dispatch<_Tp*, _Tp*, __true_type>
{
    static _Tp *copy(const _Tp* __first, const _Tp* __last, _Tp* __result)
    {
        ...
        memmove(__result - _Num, __first, sizeof(_Tp) * _Num); //将起始的copy sizeof(_Tp)*_Num位到result - _Num
...
{
    //当进行引用时，就是两个绑定在一起了，绑定不能变，但是对应的值可以变
    _Tp __tmp = __a;
    __a = __b;
    __b = __tmp;
}
...
__STL_END_NAMESPACE
#endif // ZHZ_STL_STL_ALGOBASE_H
#endif //CLION_STL_STL_ALGOBASE_H
