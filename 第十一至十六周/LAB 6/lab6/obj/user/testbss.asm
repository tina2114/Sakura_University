...
main(void) {
  ...
  800fcf:	c7 04 24 c0 13 80 00 	movl   $0x8013c0,(%esp)
  800fd6:	e8 46 f3 ff ff       	call   800321 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  800fdb:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800fe2:	00 
  800fe3:	eb 37                	jmp    80101c <main+0x56>
        if (bigarray[i] != 0) {
  800fe5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fe9:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  800ff0:	85 c0                	test   %eax,%eax
  800ff2:	74 24                	je     801018 <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  800ff4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800ff8:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800ffc:	c7 44 24 08 e0 13 80 	movl   $0x8013e0,0x8(%esp)
  801003:	00 
  801004:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80100b:	00 
  80100c:	c7 04 24 fd 13 80 00 	movl   $0x8013fd,(%esp)
  801013:	e8 08 f0 ff ff       	call   800020 <__panic>
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801018:	ff 44 24 1c          	incl   0x1c(%esp)
  80101c:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801023:	00 
  801024:	7e bf                	jle    800fe5 <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801026:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80102d:	00 
  80102e:	eb 13                	jmp    801043 <main+0x7d>
        bigarray[i] = i;
  801030:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801034:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801038:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  80103f:	ff 44 24 1c          	incl   0x1c(%esp)
  801043:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80104a:	00 
  80104b:	7e e3                	jle    801030 <main+0x6a>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80104d:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801054:	00 
  801055:	eb 3b                	jmp    801092 <main+0xcc>
        if (bigarray[i] != i) {
  801057:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80105b:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  801062:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801066:	39 c2                	cmp    %eax,%edx
  801068:	74 24                	je     80108e <main+0xc8>
            panic("bigarray[%d] didn't hold its value!\n", i);
  80106a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80106e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801072:	c7 44 24 08 0c 14 80 	movl   $0x80140c,0x8(%esp)
  801079:	00 
  80107a:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  801081:	00 
  801082:	c7 04 24 fd 13 80 00 	movl   $0x8013fd,(%esp)
  801089:	e8 92 ef ff ff       	call   800020 <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  80108e:	ff 44 24 1c          	incl   0x1c(%esp)
  801092:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801099:	00 
  80109a:	7e bb                	jle    801057 <main+0x91>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  80109c:	c7 04 24 34 14 80 00 	movl   $0x801434,(%esp)
  8010a3:	e8 79 f2 ff ff       	call   800321 <cprintf>
    cprintf("testbss may pass.\n");
  8010a8:	c7 04 24 67 14 80 00 	movl   $0x801467,(%esp)
  8010af:	e8 6d f2 ff ff       	call   800321 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  8010b4:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  8010bb:	00 00 00 
    asm volatile ("int $0x14");
  8010be:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8010c0:	c7 44 24 08 7a 14 80 	movl   $0x80147a,0x8(%esp)
  8010c7:	00 
  8010c8:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8010cf:	00 
  8010d0:	c7 04 24 fd 13 80 00 	movl   $0x8013fd,(%esp)
  8010d7:	e8 44 ef ff ff       	call   800020 <__panic>
