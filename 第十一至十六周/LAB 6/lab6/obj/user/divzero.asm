...
main(void) {
  ...
  800fcc:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  800fcf:	8b 0d 08 20 80 00    	mov    0x802008,%ecx
  800fd5:	b8 01 00 00 00       	mov    $0x1,%eax
  800fda:	99                   	cltd   
  800fdb:	f7 f9                	idiv   %ecx
  800fdd:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fe1:	c7 04 24 00 13 80 00 	movl   $0x801300,(%esp)
  800fe8:	e8 34 f3 ff ff       	call   800321 <cprintf>
    panic("FAIL: T.T\n");
  800fed:	c7 44 24 08 0e 13 80 	movl   $0x80130e,0x8(%esp)
  800ff4:	00 
  800ff5:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800ffc:	00 
  800ffd:	c7 04 24 19 13 80 00 	movl   $0x801319,(%esp)
  801004:	e8 17 f0 ff ff       	call   800020 <__panic>
