...
main(void) {
  ...
  800fcf:	e8 ae f2 ff ff       	call   800282 <getpid>
  800fd4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fd8:	c7 04 24 40 13 80 00 	movl   $0x801340,(%esp)
  800fdf:	e8 3d f3 ff ff       	call   800321 <cprintf>
    for (i = 0; i < 5; i ++) {
  800fe4:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800feb:	00 
  800fec:	eb 26                	jmp    801014 <main+0x4e>
        yield();
  800fee:	e8 6e f2 ff ff       	call   800261 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  800ff3:	e8 8a f2 ff ff       	call   800282 <getpid>
  800ff8:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  800ffc:	89 54 24 08          	mov    %edx,0x8(%esp)
  801000:	89 44 24 04          	mov    %eax,0x4(%esp)
  801004:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  80100b:	e8 11 f3 ff ff       	call   800321 <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  801010:	ff 44 24 1c          	incl   0x1c(%esp)
  801014:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801019:	7e d3                	jle    800fee <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  80101b:	e8 62 f2 ff ff       	call   800282 <getpid>
  801020:	89 44 24 04          	mov    %eax,0x4(%esp)
  801024:	c7 04 24 7f 13 80 00 	movl   $0x80137f,(%esp)
  80102b:	e8 f1 f2 ff ff       	call   800321 <cprintf>
    cprintf("yield pass.\n");
  801030:	c7 04 24 98 13 80 00 	movl   $0x801398,(%esp)
  801037:	e8 e5 f2 ff ff       	call   800321 <cprintf>
    return 0;
