...
main(void) {
  ...
  800fcf:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800fd6:	00 
  800fd7:	eb 5f                	jmp    801038 <main+0x72>
        if ((pid = fork()) == 0) {
  800fd9:	e8 40 f2 ff ff       	call   80021e <fork>
  800fde:	89 44 24 18          	mov    %eax,0x18(%esp)
  800fe2:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800fe7:	75 20                	jne    801009 <main+0x43>
            cprintf("I am child %d\n", n);
  800fe9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fed:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ff1:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
  800ff8:	e8 24 f3 ff ff       	call   800321 <cprintf>
            exit(0);
  800ffd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801004:	e8 f6 f1 ff ff       	call   8001ff <exit>
        }
        assert(pid > 0);
  801009:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80100e:	7f 24                	jg     801034 <main+0x6e>
  801010:	c7 44 24 0c d3 13 80 	movl   $0x8013d3,0xc(%esp)
  801017:	00 
  801018:	c7 44 24 08 db 13 80 	movl   $0x8013db,0x8(%esp)
  80101f:	00 
  801020:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801027:	00 
  801028:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  80102f:	e8 ec ef ff ff       	call   800020 <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  801034:	ff 44 24 1c          	incl   0x1c(%esp)
  801038:	b8 20 00 00 00       	mov    $0x20,%eax
  80103d:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801041:	7c 96                	jl     800fd9 <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
  ...
  801048:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80104c:	7e 4d                	jle    80109b <main+0xd5>
        panic("fork claimed to work %d times!\n", n);
  80104e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801052:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801056:	c7 44 24 08 00 14 80 	movl   $0x801400,0x8(%esp)
  80105d:	00 
  80105e:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801065:	00 
  801066:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  80106d:	e8 ae ef ff ff       	call   800020 <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  801072:	e8 b4 f1 ff ff       	call   80022b <wait>
  801077:	85 c0                	test   %eax,%eax
  801079:	74 1c                	je     801097 <main+0xd1>
            panic("wait stopped early\n");
  80107b:	c7 44 24 08 20 14 80 	movl   $0x801420,0x8(%esp)
  801082:	00 
  801083:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80108a:	00 
  80108b:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  801092:	e8 89 ef ff ff       	call   800020 <__panic>
    ...
    for (; n > 0; n --) {
  801097:	ff 4c 24 1c          	decl   0x1c(%esp)
  80109b:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010a0:	7f d0                	jg     801072 <main+0xac>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  8010a2:	e8 84 f1 ff ff       	call   80022b <wait>
  8010a7:	85 c0                	test   %eax,%eax
  8010a9:	75 1c                	jne    8010c7 <main+0x101>
        panic("wait got too many\n");
  8010ab:	c7 44 24 08 34 14 80 	movl   $0x801434,0x8(%esp)
  8010b2:	00 
  8010b3:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8010ba:	00 
  8010bb:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  8010c2:	e8 59 ef ff ff       	call   800020 <__panic>
    }

    cprintf("forktest pass.\n");
  8010c7:	c7 04 24 47 14 80 00 	movl   $0x801447,(%esp)
  8010ce:	e8 4e f2 ff ff       	call   800321 <cprintf>
    return 0;
