...
main(void) {
  ...
  800fcc:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  800fcf:	c7 04 24 00 13 80 00 	movl   $0x801300,(%esp)
  800fd6:	e8 46 f3 ff ff       	call   800321 <cprintf>
    cprintf("I am process %d.\n", getpid());
  800fdb:	e8 a2 f2 ff ff       	call   800282 <getpid>
  800fe0:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fe4:	c7 04 24 10 13 80 00 	movl   $0x801310,(%esp)
  800feb:	e8 31 f3 ff ff       	call   800321 <cprintf>
    cprintf("hello pass.\n");
  800ff0:	c7 04 24 22 13 80 00 	movl   $0x801322,(%esp)
