...
main(void) {
  ...
  800fcf:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  800fd6:	e8 46 f3 ff ff       	call   800321 <cprintf>
    if ((pid = fork()) == 0) {
  800fdb:	e8 3e f2 ff ff       	call   80021e <fork>
  800fe0:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  800fe4:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  800fe9:	75 3c                	jne    801027 <main+0x61>
        cprintf("I am the child.\n");
  800feb:	c7 04 24 47 14 80 00 	movl   $0x801447,(%esp)
  800ff2:	e8 2a f3 ff ff       	call   800321 <cprintf>
        yield();
  800ff7:	e8 65 f2 ff ff       	call   800261 <yield>
        yield();
  ...
  801015:	e8 47 f2 ff ff       	call   800261 <yield>
        exit(magic);
  80101a:	a1 08 20 80 00       	mov    0x802008,%eax
  80101f:	89 04 24             	mov    %eax,(%esp)
  801022:	e8 d8 f1 ff ff       	call   8001ff <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801027:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80102b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80102f:	c7 04 24 58 14 80 00 	movl   $0x801458,(%esp)
  801036:	e8 e6 f2 ff ff       	call   800321 <cprintf>
    }
    assert(pid > 0);
  80103b:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801040:	7f 24                	jg     801066 <main+0xa0>
  801042:	c7 44 24 0c 7a 14 80 	movl   $0x80147a,0xc(%esp)
  801049:	00 
  80104a:	c7 44 24 08 82 14 80 	movl   $0x801482,0x8(%esp)
  801051:	00 
  801052:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801059:	00 
  80105a:	c7 04 24 97 14 80 00 	movl   $0x801497,(%esp)
  801061:	e8 ba ef ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801066:	c7 04 24 a4 14 80 00 	movl   $0x8014a4,(%esp)
  80106d:	e8 af f2 ff ff       	call   800321 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801072:	8d 44 24 18          	lea    0x18(%esp),%eax
  801076:	89 44 24 04          	mov    %eax,0x4(%esp)
  80107a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80107e:	89 04 24             	mov    %eax,(%esp)
  801081:	e8 c1 f1 ff ff       	call   800247 <waitpid>
  801086:	85 c0                	test   %eax,%eax
  801088:	75 0d                	jne    801097 <main+0xd1>
  80108a:	8b 54 24 18          	mov    0x18(%esp),%edx
  80108e:	a1 08 20 80 00       	mov    0x802008,%eax
  801093:	39 c2                	cmp    %eax,%edx
  801095:	74 24                	je     8010bb <main+0xf5>
  801097:	c7 44 24 0c c4 14 80 	movl   $0x8014c4,0xc(%esp)
  80109e:	00 
  80109f:	c7 44 24 08 82 14 80 	movl   $0x801482,0x8(%esp)
  8010a6:	00 
  8010a7:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  8010ae:	00 
  8010af:	c7 04 24 97 14 80 00 	movl   $0x801497,(%esp)
  8010b6:	e8 65 ef ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8010bb:	8d 44 24 18          	lea    0x18(%esp),%eax
  8010bf:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010c3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010c7:	89 04 24             	mov    %eax,(%esp)
  8010ca:	e8 78 f1 ff ff       	call   800247 <waitpid>
  8010cf:	85 c0                	test   %eax,%eax
  8010d1:	74 09                	je     8010dc <main+0x116>
  8010d3:	e8 53 f1 ff ff       	call   80022b <wait>
  8010d8:	85 c0                	test   %eax,%eax
  8010da:	75 24                	jne    801100 <main+0x13a>
  8010dc:	c7 44 24 0c f0 14 80 	movl   $0x8014f0,0xc(%esp)
  8010e3:	00 
  8010e4:	c7 44 24 08 82 14 80 	movl   $0x801482,0x8(%esp)
  8010eb:	00 
  8010ec:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8010f3:	00 
  8010f4:	c7 04 24 97 14 80 00 	movl   $0x801497,(%esp)
  8010fb:	e8 20 ef ff ff       	call   800020 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  801100:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801104:	89 44 24 04          	mov    %eax,0x4(%esp)
  801108:	c7 04 24 18 15 80 00 	movl   $0x801518,(%esp)
  80110f:	e8 0d f2 ff ff       	call   800321 <cprintf>

    cprintf("exit pass.\n");
  801114:	c7 04 24 28 15 80 00 	movl   $0x801528,(%esp)
  80111b:	e8 01 f2 ff ff       	call   800321 <cprintf>
    return 0;
