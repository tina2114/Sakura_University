...
main(void) {
  ...
  800fe9:	75 0e                	jne    800ff9 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  800feb:	c7 04 24 e7 13 80 00 	movl   $0x8013e7,(%esp)
  800ff2:	e8 2a f3 ff ff       	call   800321 <cprintf>
        while (1);
  800ff7:	eb fe                	jmp    800ff7 <main+0x31>
    }
    cprintf("I am the parent. Running the child...\n");
  800ff9:	c7 04 24 08 14 80 00 	movl   $0x801408,(%esp)
  801000:	e8 1c f3 ff ff       	call   800321 <cprintf>

    yield();
  801005:	e8 57 f2 ff ff       	call   800261 <yield>
    yield();
  ...
  801014:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  80101b:	e8 01 f3 ff ff       	call   800321 <cprintf>

    assert((ret = kill(pid)) == 0);
  801020:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801024:	89 04 24             	mov    %eax,(%esp)
  801027:	e8 43 f2 ff ff       	call   80026f <kill>
  80102c:	89 44 24 18          	mov    %eax,0x18(%esp)
  801030:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801035:	74 24                	je     80105b <main+0x95>
  801037:	c7 44 24 0c 58 14 80 	movl   $0x801458,0xc(%esp)
  80103e:	00 
  80103f:	c7 44 24 08 6f 14 80 	movl   $0x80146f,0x8(%esp)
  801046:	00 
  801047:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  80104e:	00 
  80104f:	c7 04 24 84 14 80 00 	movl   $0x801484,(%esp)
  801056:	e8 c5 ef ff ff       	call   800020 <__panic>
    cprintf("kill returns %d\n", ret);
  80105b:	8b 44 24 18          	mov    0x18(%esp),%eax
  80105f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801063:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
  80106a:	e8 b2 f2 ff ff       	call   800321 <cprintf>
  ...
  80107e:	e8 c4 f1 ff ff       	call   800247 <waitpid>
  801083:	89 44 24 18          	mov    %eax,0x18(%esp)
  801087:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80108c:	74 24                	je     8010b2 <main+0xec>
  80108e:	c7 44 24 0c a4 14 80 	movl   $0x8014a4,0xc(%esp)
  801095:	00 
  801096:	c7 44 24 08 6f 14 80 	movl   $0x80146f,0x8(%esp)
  80109d:	00 
  80109e:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8010a5:	00 
  8010a6:	c7 04 24 84 14 80 00 	movl   $0x801484,(%esp)
  8010ad:	e8 6e ef ff ff       	call   800020 <__panic>
    cprintf("wait returns %d\n", ret);
  8010b2:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010b6:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010ba:	c7 04 24 c4 14 80 00 	movl   $0x8014c4,(%esp)
  8010c1:	e8 5b f2 ff ff       	call   800321 <cprintf>

    cprintf("spin may pass.\n");
  8010c6:	c7 04 24 d5 14 80 00 	movl   $0x8014d5,(%esp)
  8010cd:	e8 4f f2 ff ff       	call   800321 <cprintf>
    return 0;
