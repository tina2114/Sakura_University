...
main(void) {
  ...
  800fcf:	66 b8 28 00          	mov    $0x28,%ax
  800fd3:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  800fd5:	c7 44 24 08 e0 12 80 	movl   $0x8012e0,0x8(%esp)
  800fdc:	00 
  800fdd:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800fe4:	00 
  800fe5:	c7 04 24 eb 12 80 00 	movl   $0x8012eb,(%esp)
