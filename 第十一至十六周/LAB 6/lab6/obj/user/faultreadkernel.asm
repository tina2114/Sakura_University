...
main(void) {
  ...
  800fcf:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  800fd4:	8b 00                	mov    (%eax),%eax
  800fd6:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fda:	c7 04 24 00 13 80 00 	movl   $0x801300,(%esp)
  800fe1:	e8 3b f3 ff ff       	call   800321 <cprintf>
    panic("FAIL: T.T\n");
  800fe6:	c7 44 24 08 1e 13 80 	movl   $0x80131e,0x8(%esp)
  800fed:	00 
  800fee:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  800ff5:	00 
  800ff6:	c7 04 24 29 13 80 00 	movl   $0x801329,(%esp)
  800ffd:	e8 1e f0 ff ff       	call   800020 <__panic>
