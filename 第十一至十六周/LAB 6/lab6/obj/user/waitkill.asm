...
umain(void) {
  ...
  800399:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  80039c:	e8 ce 0c 00 00       	call   80106f <main>
...
do_yield(void) {
  ...
  800fc9:	83 ec 08             	sub    $0x8,%esp
    yield();
  800fcc:	e8 90 f2 ff ff       	call   800261 <yield>
    yield();
...
loop(void) {
  ...
  800ff0:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  800ff3:	c7 04 24 40 14 80 00 	movl   $0x801440,(%esp)
  800ffa:	e8 22 f3 ff ff       	call   800321 <cprintf>
    while (1);
  800fff:	eb fe                	jmp    800fff <loop+0x12>
...
work(void) {
  ...
  801004:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  801007:	c7 04 24 4a 14 80 00 	movl   $0x80144a,(%esp)
  80100e:	e8 0e f3 ff ff       	call   800321 <cprintf>
    do_yield();
  801013:	e8 ae ff ff ff       	call   800fc6 <do_yield>
    if (kill(parent) == 0) {
  801018:	a1 08 20 80 00       	mov    0x802008,%eax
  80101d:	89 04 24             	mov    %eax,(%esp)
  801020:	e8 4a f2 ff ff       	call   80026f <kill>
  801025:	85 c0                	test   %eax,%eax
  801027:	75 3a                	jne    801063 <work+0x62>
        cprintf("kill parent ok.\n");
  801029:	c7 04 24 54 14 80 00 	movl   $0x801454,(%esp)
  801030:	e8 ec f2 ff ff       	call   800321 <cprintf>
        do_yield();
  801035:	e8 8c ff ff ff       	call   800fc6 <do_yield>
        if (kill(pid1) == 0) {
  80103a:	a1 10 20 80 00       	mov    0x802010,%eax
  80103f:	89 04 24             	mov    %eax,(%esp)
  801042:	e8 28 f2 ff ff       	call   80026f <kill>
  801047:	85 c0                	test   %eax,%eax
  801049:	75 18                	jne    801063 <work+0x62>
            cprintf("kill child1 ok.\n");
  80104b:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  801052:	e8 ca f2 ff ff       	call   800321 <cprintf>
            exit(0);
  801057:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80105e:	e8 9c f1 ff ff       	call   8001ff <exit>
        }
    }
    exit(-1);
  801063:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80106a:	e8 90 f1 ff ff       	call   8001ff <exit>
...
main(void) {
  ...
  801072:	83 e4 f0             	and    $0xfffffff0,%esp
  801075:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801078:	e8 05 f2 ff ff       	call   800282 <getpid>
  80107d:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  801082:	e8 97 f1 ff ff       	call   80021e <fork>
  801087:	a3 10 20 80 00       	mov    %eax,0x802010
  80108c:	a1 10 20 80 00       	mov    0x802010,%eax
  801091:	85 c0                	test   %eax,%eax
  801093:	75 05                	jne    80109a <main+0x2b>
        loop();
  801095:	e8 53 ff ff ff       	call   800fed <loop>
    }

    assert(pid1 > 0);
  80109a:	a1 10 20 80 00       	mov    0x802010,%eax
  80109f:	85 c0                	test   %eax,%eax
  8010a1:	7f 24                	jg     8010c7 <main+0x58>
  8010a3:	c7 44 24 0c 76 14 80 	movl   $0x801476,0xc(%esp)
  8010aa:	00 
  8010ab:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  8010b2:	00 
  8010b3:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8010ba:	00 
  8010bb:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
  8010c2:	e8 59 ef ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  8010c7:	e8 52 f1 ff ff       	call   80021e <fork>
  8010cc:	a3 0c 20 80 00       	mov    %eax,0x80200c
  8010d1:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010d6:	85 c0                	test   %eax,%eax
  8010d8:	75 05                	jne    8010df <main+0x70>
        work();
  8010da:	e8 22 ff ff ff       	call   801001 <work>
    }
    if (pid2 > 0) {
  8010df:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010e4:	85 c0                	test   %eax,%eax
  8010e6:	7e 46                	jle    80112e <main+0xbf>
        cprintf("wait child 1.\n");
  8010e8:	c7 04 24 a4 14 80 00 	movl   $0x8014a4,(%esp)
  8010ef:	e8 2d f2 ff ff       	call   800321 <cprintf>
        waitpid(pid1, NULL);
  8010f4:	a1 10 20 80 00       	mov    0x802010,%eax
  8010f9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801100:	00 
  801101:	89 04 24             	mov    %eax,(%esp)
  801104:	e8 3e f1 ff ff       	call   800247 <waitpid>
        panic("waitpid %d returns\n", pid1);
  801109:	a1 10 20 80 00       	mov    0x802010,%eax
  80110e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801112:	c7 44 24 08 b3 14 80 	movl   $0x8014b3,0x8(%esp)
  801119:	00 
  80111a:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  801121:	00 
  801122:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
  801129:	e8 f2 ee ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  80112e:	a1 10 20 80 00       	mov    0x802010,%eax
  801133:	89 04 24             	mov    %eax,(%esp)
  801136:	e8 34 f1 ff ff       	call   80026f <kill>
    }
    panic("FAIL: T.T\n");
  80113b:	c7 44 24 08 c7 14 80 	movl   $0x8014c7,0x8(%esp)
  801142:	00 
  801143:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  80114a:	00 
  80114b:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
  801152:	e8 c9 ee ff ff       	call   800020 <__panic>
