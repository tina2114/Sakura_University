...
main(void) {
  ...
  800fcc:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  800fcf:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  800fd1:	c7 44 24 08 e0 12 80 	movl   $0x8012e0,0x8(%esp)
  800fd8:	00 
  800fd9:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  800fe0:	00 
  800fe1:	c7 04 24 eb 12 80 00 	movl   $0x8012eb,(%esp)
  800fe8:	e8 33 f0 ff ff       	call   800020 <__panic>
