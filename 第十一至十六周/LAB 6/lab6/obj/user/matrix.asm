...
umain(void) {
  ...
  800399:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  80039c:	e8 52 0e 00 00       	call   8011f3 <main>
...
work(unsigned int times) {
  ...
  800fc9:	53                   	push   %ebx
  800fca:	83 ec 24             	sub    $0x24,%esp
    int i, j, k, size = MATSIZE;
  800fcd:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  800fd4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800fdb:	eb 63                	jmp    801040 <work+0x7a>
        for (j = 0; j < size; j ++) {
  800fdd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  800fe4:	eb 4f                	jmp    801035 <work+0x6f>
            mata[i][j] = matb[i][j] = 1;
  800fe6:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800fe9:	89 d0                	mov    %edx,%eax
  800feb:	c1 e0 02             	shl    $0x2,%eax
  800fee:	01 d0                	add    %edx,%eax
  800ff0:	01 c0                	add    %eax,%eax
  800ff2:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800ff5:	01 d0                	add    %edx,%eax
  800ff7:	c7 04 85 c0 21 80 00 	movl   $0x1,0x8021c0(,%eax,4)
  800ffe:	01 00 00 00 
  ...
  80100e:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801011:	01 d0                	add    %edx,%eax
  801013:	8b 0c 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%ecx
  80101a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80101d:	89 d0                	mov    %edx,%eax
  80101f:	c1 e0 02             	shl    $0x2,%eax
  801022:	01 d0                	add    %edx,%eax
  801024:	01 c0                	add    %eax,%eax
  801026:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801029:	01 d0                	add    %edx,%eax
  80102b:	89 0c 85 20 20 80 00 	mov    %ecx,0x802020(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  801032:	ff 45 f0             	incl   -0x10(%ebp)
  801035:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801038:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80103b:	7c a9                	jl     800fe6 <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
  ...
  801043:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801046:	7c 95                	jl     800fdd <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801048:	e8 14 f2 ff ff       	call   800261 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  80104d:	e8 30 f2 ff ff       	call   800282 <getpid>
  801052:	8b 55 08             	mov    0x8(%ebp),%edx
  801055:	89 54 24 08          	mov    %edx,0x8(%esp)
  801059:	89 44 24 04          	mov    %eax,0x4(%esp)
  80105d:	c7 04 24 a0 16 80 00 	movl   $0x8016a0,(%esp)
  801064:	e8 b8 f2 ff ff       	call   800321 <cprintf>

    while (times -- > 0) {
  801069:	e9 53 01 00 00       	jmp    8011c1 <work+0x1fb>
        for (i = 0; i < size; i ++) {
  80106e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801075:	e9 b3 00 00 00       	jmp    80112d <work+0x167>
            for (j = 0; j < size; j ++) {
  80107a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801081:	e9 98 00 00 00       	jmp    80111e <work+0x158>
                matc[i][j] = 0;
  ...
  801097:	c7 04 85 60 23 80 00 	movl   $0x0,0x802360(,%eax,4)
  80109e:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8010a2:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8010a9:	eb 68                	jmp    801113 <work+0x14d>
  ...
  8010bc:	8b 0c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ecx
  8010c3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8010c6:	89 d0                	mov    %edx,%eax
  8010c8:	c1 e0 02             	shl    $0x2,%eax
  8010cb:	01 d0                	add    %edx,%eax
  8010cd:	01 c0                	add    %eax,%eax
  8010cf:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8010d2:	01 d0                	add    %edx,%eax
  8010d4:	8b 1c 85 20 20 80 00 	mov    0x802020(,%eax,4),%ebx
  ...
  8010ec:	8b 04 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%eax
  8010f3:	0f af c3             	imul   %ebx,%eax
  8010f6:	01 c1                	add    %eax,%ecx
  8010f8:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8010fb:	89 d0                	mov    %edx,%eax
  8010fd:	c1 e0 02             	shl    $0x2,%eax
  801100:	01 d0                	add    %edx,%eax
  801102:	01 c0                	add    %eax,%eax
  801104:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801107:	01 d0                	add    %edx,%eax
  801109:	89 0c 85 60 23 80 00 	mov    %ecx,0x802360(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  801110:	ff 45 ec             	incl   -0x14(%ebp)
  801113:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801116:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801119:	7c 90                	jl     8010ab <work+0xe5>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  80111b:	ff 45 f0             	incl   -0x10(%ebp)
  80111e:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801121:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801124:	0f 8c 5c ff ff ff    	jl     801086 <work+0xc0>
    yield();
  ...
  801130:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801133:	0f 8c 41 ff ff ff    	jl     80107a <work+0xb4>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  801140:	eb 77                	jmp    8011b9 <work+0x1f3>
            for (j = 0; j < size; j ++) {
  801142:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801149:	eb 63                	jmp    8011ae <work+0x1e8>
  ...
  80115c:	8b 0c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ecx
  ...
  801174:	89 0c 85 c0 21 80 00 	mov    %ecx,0x8021c0(,%eax,4)
  ...
  80118c:	8b 0c 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%ecx
  801193:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801196:	89 d0                	mov    %edx,%eax
  801198:	c1 e0 02             	shl    $0x2,%eax
  80119b:	01 d0                	add    %edx,%eax
  80119d:	01 c0                	add    %eax,%eax
  80119f:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8011a2:	01 d0                	add    %edx,%eax
  8011a4:	89 0c 85 20 20 80 00 	mov    %ecx,0x802020(,%eax,4)
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        }
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8011ab:	ff 45 f0             	incl   -0x10(%ebp)
  8011ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8011b1:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8011b4:	7c 95                	jl     80114b <work+0x185>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  8011b6:	ff 45 f4             	incl   -0xc(%ebp)
  8011b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8011bc:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8011bf:	7c 81                	jl     801142 <work+0x17c>
  ...
  8011cc:	0f 85 9c fe ff ff    	jne    80106e <work+0xa8>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  8011d2:	e8 ab f0 ff ff       	call   800282 <getpid>
  8011d7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011db:	c7 04 24 c0 16 80 00 	movl   $0x8016c0,(%esp)
  8011e2:	e8 3a f1 ff ff       	call   800321 <cprintf>
    exit(0);
  8011e7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8011ee:	e8 0c f0 ff ff       	call   8001ff <exit>
...
int
main(void) {
  8011f3:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  8011f7:	83 e4 f0             	and    $0xfffffff0,%esp
  8011fa:	ff 71 fc             	pushl  -0x4(%ecx)
  8011fd:	55                   	push   %ebp
  8011fe:	89 e5                	mov    %esp,%ebp
  801200:	53                   	push   %ebx
  801201:	51                   	push   %ecx
  801202:	83 ec 20             	sub    $0x20,%esp
  801205:	89 e0                	mov    %esp,%eax
  801207:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801209:	b8 15 00 00 00       	mov    $0x15,%eax
  80120e:	48                   	dec    %eax
  80120f:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801212:	b8 15 00 00 00       	mov    $0x15,%eax
  801217:	c1 e0 02             	shl    $0x2,%eax
  80121a:	8d 50 03             	lea    0x3(%eax),%edx
  80121d:	b8 10 00 00 00       	mov    $0x10,%eax
  801222:	48                   	dec    %eax
  801223:	01 d0                	add    %edx,%eax
  801225:	b9 10 00 00 00       	mov    $0x10,%ecx
  80122a:	ba 00 00 00 00       	mov    $0x0,%edx
  80122f:	f7 f1                	div    %ecx
  801231:	6b c0 10             	imul   $0x10,%eax,%eax
  801234:	29 c4                	sub    %eax,%esp
  801236:	8d 44 24 0c          	lea    0xc(%esp),%eax
  80123a:	83 c0 03             	add    $0x3,%eax
  80123d:	c1 e8 02             	shr    $0x2,%eax
  801240:	c1 e0 02             	shl    $0x2,%eax
  801243:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  801246:	b8 15 00 00 00       	mov    $0x15,%eax
  80124b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801252:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801255:	89 54 24 08          	mov    %edx,0x8(%esp)
  801259:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801260:	00 
  801261:	89 04 24             	mov    %eax,(%esp)
  801264:	e8 66 f4 ff ff       	call   8006cf <memset>

    int i;
    for (i = 0; i < total; i ++) {
  801269:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801270:	eb 7f                	jmp    8012f1 <main+0xfe>
        if ((pids[i] = fork()) == 0) {
  801272:	e8 a7 ef ff ff       	call   80021e <fork>
  801277:	89 c1                	mov    %eax,%ecx
  801279:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80127c:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80127f:	89 0c 90             	mov    %ecx,(%eax,%edx,4)
  801282:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801285:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801288:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80128b:	85 c0                	test   %eax,%eax
  80128d:	75 52                	jne    8012e1 <main+0xee>
            srand(i * i);
  80128f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801292:	0f af 45 f4          	imul   -0xc(%ebp),%eax
  801296:	89 04 24             	mov    %eax,(%esp)
  801299:	e8 0f fd ff ff       	call   800fad <srand>
            int times = (((unsigned int)rand()) % total);
  80129e:	e8 4b fc ff ff       	call   800eee <rand>
  8012a3:	ba 15 00 00 00       	mov    $0x15,%edx
  8012a8:	89 d1                	mov    %edx,%ecx
  8012aa:	ba 00 00 00 00       	mov    $0x0,%edx
  8012af:	f7 f1                	div    %ecx
  8012b1:	89 d0                	mov    %edx,%eax
  8012b3:	89 45 e8             	mov    %eax,-0x18(%ebp)
            times = (times * times + 10) * 100;
  8012b6:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8012b9:	0f af 45 e8          	imul   -0x18(%ebp),%eax
  8012bd:	8d 50 0a             	lea    0xa(%eax),%edx
  8012c0:	89 d0                	mov    %edx,%eax
  8012c2:	c1 e0 02             	shl    $0x2,%eax
  ...
  8012d3:	89 45 e8             	mov    %eax,-0x18(%ebp)
            work(times);
  8012d6:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8012d9:	89 04 24             	mov    %eax,(%esp)
  8012dc:	e8 e5 fc ff ff       	call   800fc6 <work>
        }
        if (pids[i] < 0) {
  8012e1:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8012e4:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8012e7:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8012ea:	85 c0                	test   %eax,%eax
  8012ec:	78 5f                	js     80134d <main+0x15a>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  8012ee:	ff 45 f4             	incl   -0xc(%ebp)
  8012f1:	b8 15 00 00 00       	mov    $0x15,%eax
  8012f6:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  8012f9:	0f 8c 73 ff ff ff    	jl     801272 <main+0x7f>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  8012ff:	c7 04 24 d4 16 80 00 	movl   $0x8016d4,(%esp)
  801306:	e8 16 f0 ff ff       	call   800321 <cprintf>

    for (i = 0; i < total; i ++) {
  80130b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801312:	eb 1a                	jmp    80132e <main+0x13b>
        if (wait() != 0) {
  801314:	e8 12 ef ff ff       	call   80022b <wait>
  801319:	85 c0                	test   %eax,%eax
  80131b:	74 0e                	je     80132b <main+0x138>
            cprintf("wait failed.\n");
  80131d:	c7 04 24 de 16 80 00 	movl   $0x8016de,(%esp)
  801324:	e8 f8 ef ff ff       	call   800321 <cprintf>
            goto failed;
  801329:	eb 23                	jmp    80134e <main+0x15b>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  80132b:	ff 45 f4             	incl   -0xc(%ebp)
  80132e:	b8 15 00 00 00       	mov    $0x15,%eax
  801333:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801336:	7c dc                	jl     801314 <main+0x121>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  801338:	c7 04 24 ec 16 80 00 	movl   $0x8016ec,(%esp)
  80133f:	e8 dd ef ff ff       	call   800321 <cprintf>
    return 0;
  801344:	b8 00 00 00 00       	mov    $0x0,%eax
  801349:	89 dc                	mov    %ebx,%esp
  80134b:	eb 51                	jmp    80139e <main+0x1ab>
            int times = (((unsigned int)rand()) % total);
            times = (times * times + 10) * 100;
            work(times);
        }
...
failed:
  ...
  801378:	b8 15 00 00 00       	mov    $0x15,%eax
  80137d:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801380:	7c d5                	jl     801357 <main+0x164>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  801382:	c7 44 24 08 fa 16 80 	movl   $0x8016fa,0x8(%esp)
  801389:	00 
  80138a:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801391:	00 
  801392:	c7 04 24 05 17 80 00 	movl   $0x801705,(%esp)
  801399:	e8 82 ec ff ff       	call   800020 <__panic>
}
  80139e:	8d 65 f8             	lea    -0x8(%ebp),%esp
  8013a1:	59                   	pop    %ecx
  8013a2:	5b                   	pop    %ebx
  8013a3:	5d                   	pop    %ebp
  8013a4:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8013a7:	c3                   	ret    
