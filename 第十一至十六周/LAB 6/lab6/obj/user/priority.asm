...
umain(void) {
  ...
  800399:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  80039c:	e8 51 0c 00 00       	call   800ff2 <main>
...
spin_delay(void)
{
  ...
  800fd3:	eb 11                	jmp    800fe6 <spin_delay+0x20>
     {
          j = !j;
...
spin_delay(void)
{
  ...
  800fe6:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  800fed:	75 e6                	jne    800fd5 <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  800ff5:	53                   	push   %ebx
  800ff6:	83 e4 f0             	and    $0xfffffff0,%esp
  800ff9:	83 ec 20             	sub    $0x20,%esp
     int i,time;
     memset(pids, 0, sizeof(pids));
  800ffc:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  801003:	00 
  801004:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80100b:	00 
  80100c:	c7 04 24 30 20 80 00 	movl   $0x802030,(%esp)
  801013:	e8 b7 f6 ff ff       	call   8006cf <memset>
     lab6_set_priority(TOTAL + 1);
  801018:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  80101f:	e8 86 f2 ff ff       	call   8002aa <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  801024:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80102b:	00 
  80102c:	e9 fe 00 00 00       	jmp    80112f <main+0x13d>
          acc[i]=0;
  801031:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801035:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  80103c:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801040:	e8 d9 f1 ff ff       	call   80021e <fork>
  801045:	89 c2                	mov    %eax,%edx
  801047:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80104b:	89 14 85 30 20 80 00 	mov    %edx,0x802030(,%eax,4)
  801052:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801056:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  80105d:	85 c0                	test   %eax,%eax
  80105f:	0f 85 b3 00 00 00    	jne    801118 <main+0x126>
               lab6_set_priority(i + 1);
  801065:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801069:	40                   	inc    %eax
  80106a:	89 04 24             	mov    %eax,(%esp)
  80106d:	e8 38 f2 ff ff       	call   8002aa <lab6_set_priority>
               acc[i] = 0;
  801072:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801076:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  80107d:	00 00 00 00 
               while (1) {
                    spin_delay();
  801081:	e8 40 ff ff ff       	call   800fc6 <spin_delay>
                    ++ acc[i];
  801086:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80108a:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  801091:	8d 50 01             	lea    0x1(%eax),%edx
  801094:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801098:	89 14 85 08 20 80 00 	mov    %edx,0x802008(,%eax,4)
                    if(acc[i]%4000==0) {
  80109f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010a3:	8b 0c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ecx
  8010aa:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8010af:	89 c8                	mov    %ecx,%eax
  8010b1:	f7 e2                	mul    %edx
  8010b3:	89 d0                	mov    %edx,%eax
  8010b5:	c1 e8 08             	shr    $0x8,%eax
  8010b8:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8010be:	29 c1                	sub    %eax,%ecx
  8010c0:	89 c8                	mov    %ecx,%eax
  8010c2:	85 c0                	test   %eax,%eax
  8010c4:	75 bb                	jne    801081 <main+0x8f>
                        if((time=gettime_msec())>MAX_TIME) {
  8010c6:	e8 d2 f1 ff ff       	call   80029d <gettime_msec>
  8010cb:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010cf:	81 7c 24 18 e8 03 00 	cmpl   $0x3e8,0x18(%esp)
  8010d6:	00 
  8010d7:	7e a8                	jle    801081 <main+0x8f>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  8010d9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010dd:	8b 1c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ebx
  8010e4:	e8 99 f1 ff ff       	call   800282 <getpid>
  8010e9:	8b 54 24 18          	mov    0x18(%esp),%edx
  8010ed:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8010f1:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8010f5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010f9:	c7 04 24 80 15 80 00 	movl   $0x801580,(%esp)
  801100:	e8 1c f2 ff ff       	call   800321 <cprintf>
                            exit(acc[i]);
  801105:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801109:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  801110:	89 04 24             	mov    %eax,(%esp)
  801113:	e8 e7 f0 ff ff       	call   8001ff <exit>
                        }
                    }
               }
          ...
          if (pids[i] < 0) {
  801118:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80111c:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801123:	85 c0                	test   %eax,%eax
  801125:	0f 88 08 01 00 00    	js     801233 <main+0x241>
main(void) {
     int i,time;
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  80112b:	ff 44 24 1c          	incl   0x1c(%esp)
  80112f:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801134:	0f 8e f7 fe ff ff    	jle    801031 <main+0x3f>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  80113a:	c7 04 24 a0 15 80 00 	movl   $0x8015a0,(%esp)
  801141:	e8 db f1 ff ff       	call   800321 <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  801146:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80114d:	00 
  80114e:	eb 6c                	jmp    8011bc <main+0x1ca>
         status[i]=0;
  801150:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801154:	c7 04 85 1c 20 80 00 	movl   $0x0,0x80201c(,%eax,4)
  80115b:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  80115f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801163:	c1 e0 02             	shl    $0x2,%eax
  801166:	8d 90 1c 20 80 00    	lea    0x80201c(%eax),%edx
  80116c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801170:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801177:	89 54 24 04          	mov    %edx,0x4(%esp)
  80117b:	89 04 24             	mov    %eax,(%esp)
  80117e:	e8 c4 f0 ff ff       	call   800247 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  801183:	e8 15 f1 ff ff       	call   80029d <gettime_msec>
  801188:	89 c1                	mov    %eax,%ecx
  80118a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80118e:	8b 14 85 1c 20 80 00 	mov    0x80201c(,%eax,4),%edx
  801195:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801199:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8011a0:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  8011a4:	89 54 24 08          	mov    %edx,0x8(%esp)
  8011a8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011ac:	c7 04 24 c8 15 80 00 	movl   $0x8015c8,(%esp)
  8011b3:	e8 69 f1 ff ff       	call   800321 <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  8011b8:	ff 44 24 1c          	incl   0x1c(%esp)
  8011bc:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8011c1:	7e 8d                	jle    801150 <main+0x15e>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  8011c3:	c7 04 24 e7 15 80 00 	movl   $0x8015e7,(%esp)
  8011ca:	e8 52 f1 ff ff       	call   800321 <cprintf>
     cprintf("stride sched correct result:");
  8011cf:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
  8011d6:	e8 46 f1 ff ff       	call   800321 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  8011db:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8011e2:	00 
  8011e3:	eb 34                	jmp    801219 <main+0x227>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  8011e5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011e9:	8b 04 85 1c 20 80 00 	mov    0x80201c(,%eax,4),%eax
  8011f0:	01 c0                	add    %eax,%eax
  8011f2:	8b 1d 1c 20 80 00    	mov    0x80201c,%ebx
  8011f8:	99                   	cltd   
  8011f9:	f7 fb                	idiv   %ebx
  8011fb:	40                   	inc    %eax
  8011fc:	89 c2                	mov    %eax,%edx
  8011fe:	c1 ea 1f             	shr    $0x1f,%edx
  801201:	01 d0                	add    %edx,%eax
  801203:	d1 f8                	sar    %eax
  801205:	89 44 24 04          	mov    %eax,0x4(%esp)
  801209:	c7 04 24 1a 16 80 00 	movl   $0x80161a,(%esp)
  801210:	e8 0c f1 ff ff       	call   800321 <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801215:	ff 44 24 1c          	incl   0x1c(%esp)
  801219:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  80121e:	7e c5                	jle    8011e5 <main+0x1f3>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801220:	c7 04 24 1e 16 80 00 	movl   $0x80161e,(%esp)
  801227:	e8 f5 f0 ff ff       	call   800321 <cprintf>

     return 0;
  80122c:	b8 00 00 00 00       	mov    $0x0,%eax
  801231:	eb 54                	jmp    801287 <main+0x295>
                    }
               }
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801234:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80123b:	00 
  80123c:	eb 26                	jmp    801264 <main+0x272>
          if (pids[i] > 0) {
  80123e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801242:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801249:	85 c0                	test   %eax,%eax
  80124b:	7e 13                	jle    801260 <main+0x26e>
               kill(pids[i]);
  80124d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801251:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801258:	89 04 24             	mov    %eax,(%esp)
  80125b:	e8 0f f0 ff ff       	call   80026f <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801260:	ff 44 24 1c          	incl   0x1c(%esp)
  801264:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801269:	7e d3                	jle    80123e <main+0x24c>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  80126b:	c7 44 24 08 20 16 80 	movl   $0x801620,0x8(%esp)
  801272:	00 
  801273:	c7 44 24 04 4b 00 00 	movl   $0x4b,0x4(%esp)
  80127a:	00 
  80127b:	c7 04 24 2b 16 80 00 	movl   $0x80162b,(%esp)
  801282:	e8 99 ed ff ff       	call   800020 <__panic>
}
