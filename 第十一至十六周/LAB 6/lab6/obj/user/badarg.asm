...
umain(void) {
  ...
  800399:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  80039c:	e8 25 0c 00 00       	call   800fc6 <main>
...
main(void) {
  ...
  800fc9:	83 e4 f0             	and    $0xfffffff0,%esp
  800fcc:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800fcf:	e8 4a f2 ff ff       	call   80021e <fork>
  800fd4:	89 44 24 18          	mov    %eax,0x18(%esp)
  800fd8:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800fdd:	75 32                	jne    801011 <main+0x4b>
        cprintf("fork ok.\n");
  800fdf:	c7 04 24 00 14 80 00 	movl   $0x801400,(%esp)
  800fe6:	e8 36 f3 ff ff       	call   800321 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  800feb:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800ff2:	00 
  800ff3:	eb 09                	jmp    800ffe <main+0x38>
            yield();
  800ff5:	e8 67 f2 ff ff       	call   800261 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  800ffa:	ff 44 24 1c          	incl   0x1c(%esp)
  800ffe:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  801003:	7e f0                	jle    800ff5 <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  801005:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  80100c:	e8 ee f1 ff ff       	call   8001ff <exit>
    }
    assert(pid > 0);
  801011:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801016:	7f 24                	jg     80103c <main+0x76>
  801018:	c7 44 24 0c 0a 14 80 	movl   $0x80140a,0xc(%esp)
  80101f:	00 
  801020:	c7 44 24 08 12 14 80 	movl   $0x801412,0x8(%esp)
  801027:	00 
  801028:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  80102f:	00 
  801030:	c7 04 24 27 14 80 00 	movl   $0x801427,(%esp)
  801037:	e8 e4 ef ff ff       	call   800020 <__panic>
    assert(waitpid(-1, NULL) != 0);
  80103c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801043:	00 
  801044:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80104b:	e8 f7 f1 ff ff       	call   800247 <waitpid>
  801050:	85 c0                	test   %eax,%eax
  801052:	75 24                	jne    801078 <main+0xb2>
  801054:	c7 44 24 0c 35 14 80 	movl   $0x801435,0xc(%esp)
  80105b:	00 
  80105c:	c7 44 24 08 12 14 80 	movl   $0x801412,0x8(%esp)
  801063:	00 
  801064:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  80106b:	00 
  80106c:	c7 04 24 27 14 80 00 	movl   $0x801427,(%esp)
  801073:	e8 a8 ef ff ff       	call   800020 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801078:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  80107f:	c0 
  801080:	8b 44 24 18          	mov    0x18(%esp),%eax
  801084:	89 04 24             	mov    %eax,(%esp)
  801087:	e8 bb f1 ff ff       	call   800247 <waitpid>
  80108c:	85 c0                	test   %eax,%eax
  80108e:	75 24                	jne    8010b4 <main+0xee>
  801090:	c7 44 24 0c 4c 14 80 	movl   $0x80144c,0xc(%esp)
  801097:	00 
  801098:	c7 44 24 08 12 14 80 	movl   $0x801412,0x8(%esp)
  80109f:	00 
  8010a0:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  8010a7:	00 
  8010a8:	c7 04 24 27 14 80 00 	movl   $0x801427,(%esp)
  8010af:	e8 6c ef ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  8010b4:	8d 44 24 14          	lea    0x14(%esp),%eax
  8010b8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010bc:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010c0:	89 04 24             	mov    %eax,(%esp)
  8010c3:	e8 7f f1 ff ff       	call   800247 <waitpid>
  8010c8:	85 c0                	test   %eax,%eax
  8010ca:	75 0b                	jne    8010d7 <main+0x111>
  8010cc:	8b 44 24 14          	mov    0x14(%esp),%eax
  8010d0:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8010d5:	74 24                	je     8010fb <main+0x135>
  8010d7:	c7 44 24 0c 74 14 80 	movl   $0x801474,0xc(%esp)
  8010de:	00 
  8010df:	c7 44 24 08 12 14 80 	movl   $0x801412,0x8(%esp)
  8010e6:	00 
  8010e7:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8010ee:	00 
  8010ef:	c7 04 24 27 14 80 00 	movl   $0x801427,(%esp)
  8010f6:	e8 25 ef ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  8010fb:	c7 04 24 a9 14 80 00 	movl   $0x8014a9,(%esp)
  801102:	e8 1a f2 ff ff       	call   800321 <cprintf>
    return 0;
